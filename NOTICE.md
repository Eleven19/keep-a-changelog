...
This file includes attribution information.

## The project uses code from/or derived from [ckipp01/mill-ci-release](https://github.com/ckipp01/mill-ci-release) in its build process

mill-ci-release is licensed under Apache 2.0:
